...
$limite_por_pagina = 500; // Define o número de registros por página
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                ...
                redFrom: 0, redTo: 5, // Zona vermelha (poucos usuários)
                yellowFrom: 5, yellowTo: 10, // Zona amarela
                greenFrom: 10, greenTo: 100, // Zona verde (meta de 100)
                minorTicks: 5,
                max: 100 // Escala máxima do seu medidor
            };
